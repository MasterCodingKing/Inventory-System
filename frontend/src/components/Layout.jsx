...
const navigation = [
  ...
  { name: 'Borrow/Return', href: '/borrow', icon: ArrowsRightLeftIcon },
  { name: 'Disposal', href: '/disposal', icon: TrashIcon, roles: ['admin', 'manager'] },
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-700 px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center">
                    ...
                    <span className="ml-2 text-xl font-semibold text-white">IT Inventory</span>
                  </div>
          ...
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <div className="flex items-center gap-x-4 px-2 py-3 text-sm font-semibold leading-6 text-primary-100">
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex flex-1 items-center">
              <h1 className="text-lg font-semibold text-gray-900">FFCC PC-Windows Account Inventory</h1>
            </div>
